...
{
    /// <inheritdoc />
    public partial class HRLeaveManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDays = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
                    UsedDays = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultDays = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
                    IsPaid = table.Column<bool>(type: "boolean", nullable: false),
                    IsCarryForward = table.Column<bool>(type: "boolean", nullable: false),
                    MaxCarryForward = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveAllocations_Employee_Type_Year",
                table: "LeaveAllocations",
                columns: new[] { "EmployeeId", "LeaveTypeId", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_CompanyId_Dates",
                table: "LeaveRequests",
