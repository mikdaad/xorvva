// <auto-generated />
// NOTE: this Designer deliberately reproduces the target model of the previous migration
// (20260830084752_HrFiles). AccountingSqlPort changes the DATABASE through the embedded
// Sql/Accounting/*.sql scripts, not through the EF model, so its target model is unchanged.
// The EF read-model catch-up (mapping of the SQL-created tables/columns) is the next,
// empty-bodied migration — see the procedure in 20260917120000_AccountingSqlPort.cs.
using System;
...
namespace Xorva.Infrastructure.Migrations
{
    ...
    partial class AccountingSqlPort
    {
        /// <inheritdoc />
