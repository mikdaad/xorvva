              ...
              <tbody className="divide-y divide-border">
                {rows.map((b) => (
                  <tr key={b.id} className="hover:bg-hover">
                    <td className="px-4 py-3 text-frost">{b.name}</td>
                    <td className="px-4 py-3 text-frost-dim">{b.bankName ?? '—'}</td>
                    <td className="px-4 py-3 font-mono text-xs text-dim">{b.accountNumber ?? '—'}</td>
                    <td className="px-4 py-3 font-mono text-xs text-dim">{b.iban ?? '—'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
